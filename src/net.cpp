...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SmashCoinLite " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    //{"smashcoinlitetools.com", "dnsseed.smashcoinlitetools.com"},
    {"smashcoinlitepool.org", "dnsseed.smashcoinlitepool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"smashcoinlitetools.com", "testnet-seed.smashcoinlitetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SmashCoinLite is probably already running."), addrBind.ToString().c_str());
        else
